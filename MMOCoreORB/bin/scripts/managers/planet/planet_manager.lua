...
-- NON-STOCK: shuttles are effectively always boardable. Stock values were
-- away 300/60, landing 11/14, landed 120/120. 0 is not usable: PlanetManager
-- replaces any value <= 0 with the stock default. The landed time is kept under
-- ~2,147,000 seconds because ShuttleDepartureTask schedules it in milliseconds as
-- a 32-bit int; 2,000,000 seconds is about 23 days, after which a shuttle leaves
-- for one second and lands again.
...
shuttleportLandedTime = 2000000
starportLandedTime = 2000000
